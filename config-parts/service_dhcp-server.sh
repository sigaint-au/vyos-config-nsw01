...
set service dhcp-server shared-network-name NET_NSW01_MGMT subnet 10.120.10.0/24 static-mapping idrac-6BFVY42 mac-address '74:e6:e2:fa:70:06'
...
set service dhcp-server shared-network-name NET_NSW01_MGMT subnet 10.120.10.0/24 static-mapping idrac-8505qm2 mac-address '58:8a:5a:e7:4a:c2'
...
set service dhcp-server shared-network-name NET_NSW01_MGMT subnet 10.120.10.0/24 static-mapping idrac-9qk2vg2 mac-address '84:7b:eb:d9:0d:c'
...
set service dhcp-server shared-network-name NET_NSW01_MGMT subnet 10.120.10.0/24 static-mapping idrac-9qd4vg2 mac-address ' 84:7b:eb:d9:0d:bc'
...
set service dhcp-server shared-network-name NET_NSW01_MGMT subnet 10.120.10.0/24 static-mapping xcc-7x02-j300cw5m mac-address '7c:d3:0a:59:3f:95'
...
set service dhcp-server shared-network-name NET_NSW01_MGMT subnet  10.120.10.0/24 static-mapping xcc-7x02-j300cw5k mac-address '38:68:dd:05:7e:dd'
...
set service dhcp-server shared-network-name NET_NSW01_HOSTING subnet  10.120.14.0/24 static-mapping lan-node-01 mac-address '44:a8:42:0a:5e:e7'
...
set service dhcp-server shared-network-name NET_NSW01_HOSTING subnet  10.120.14.0/24 static-mapping lan-node-02 mac-address '80:18:44:ec:23:e6'
...
set service dhcp-server shared-network-name NET_NSW01_HOSTING subnet  10.120.14.0/24 static-mapping lan-node-03 mac-address '18:66:da:ef:6d:8a'
...
set service dhcp-server shared-network-name NET_NSW01_HOSTING subnet  10.120.14.0/24 static-mapping lan-node-04 mac-address '18:66:da:ef:7d:aa'
...
set service dhcp-server shared-network-name NET_NSW01_HOSTING subnet  10.120.14.0/24 static-mapping lan-node-05 mac-address '7c:d3:0a:59:3f:90'
...
set service dhcp-server shared-network-name NET_NSW01_HOSTING subnet  10.120.14.0/24 static-mapping lan-node-06 mac-address '38:68:dd:05:7e:d8'
