...
# DMZ
set service dhcpv6-server shared-network-name NET_NSW01_DMZ_6 option domain-search 'dmz.sigaint.au'
...
# WIFI
set service dhcpv6-server shared-network-name NET_NSW01_WIFI_6 option domain-search 'corp.sigaint.au'
...
# Hosting
set service dhcpv6-server shared-network-name NET_NSW01_HOSTING_6 option domain-search 'hosting.sigaint.au'
...
# VMNET
set service dhcpv6-server shared-network-name NET_NSW01_VMNET_6 option domain-search 'vmnet.sigaint.au'
