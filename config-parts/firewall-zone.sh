...
set firewall zone DMZ from HOSTING firewall name 'HOSTING-DMZ'
set firewall zone DMZ from HOSTING firewall ipv6-name 'HOSTING-DMZ-6'
...
set firewall zone HOSTING from DMZ firewall name 'DMZ-HOSTING'
set firewall zone HOSTING from DMZ firewall ipv6-name 'DMZ-HOSTING-6'
