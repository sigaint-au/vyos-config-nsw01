...
set firewall zone DMZ from VMNET firewall name 'HOSTING-DMZ'
set firewall zone DMZ from VMNET firewall ipv6-name 'HOSTING-DMZ-6'
...
set firewall zone HOSTING from WAN firewall name 'DMZ-HOSTING'
set firewall zone HOSTING from WAN firewall ipv6-name 'DMZ-HOSTING-6'
