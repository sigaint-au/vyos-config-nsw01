...
set firewall zone HOSTING from PROTON_VPN firewall name 'PROTON_VPN-HOSTING'
set firewall zone HOSTING from PROTON_VPN firewall ipv6-name 'PROTON_VPN-HOSTING-6'
...
set firewall zone PROTON_VPN from HOSTING firewall name 'HOSTING-PROTON_VPN'
set firewall zone PROTON_VPN from HOSTING firewall ipv6-name 'HOSTING-PROTON_VPN-6'
set firewall zone PROTON_VPN from ADMIN firewall name 'ADMIN-PROTON_VPN'
