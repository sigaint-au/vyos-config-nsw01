...
set firewall zone ADMIN from HOSTING firewall name 'HOSTING-ADMIN'
...
set firewall zone HOSTING from ADMIN firewall name 'ADMIN-HOSTING'
set firewall zone HOSTING from ADMIN firewall ipv6-name 'ADMIN-HOSTING-6'
...
set firewall zone WIFI from VMNET firewall name 'VMNET-WIFI'
set firewall zone WIFI from VMNET firewall ipv6-name 'VMNET-WIFI-6'
...
set firewall zone VMNET from WIFI firewall name 'WIFI-VMNET'
set firewall zone VMNET from WIFI firewall ipv6-name 'WIFI-VMNET-6'
set firewall zone VMNET from DMZ firewall name 'DMZ-VMNET'
set firewall zone VMNET from DMZ firewall ipv6-name 'DMZ-VMNET-6'
