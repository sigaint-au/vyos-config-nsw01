...
# WAN -> DMZ
set firewall ipv6 name WAN-DMZ-6 default-action 'reject'
...
set firewall ipv6 name DMZ-LOCAL-6 rule 120 action 'accept'
set firewall ipv6 name DMZ-LOCAL-6 rule 120 state 'established'
set firewall ipv6 name DMZ-LOCAL-6 rule 120 state 'related'
set firewall ipv6 name DMZ-LOCAL-6 rule 130 action 'drop'
set firewall ipv6 name DMZ-LOCAL-6 rule 130 state 'invalid'
set firewall ipv6 name DMZ-LOCAL-6 rule 140 action 'accept'
set firewall ipv6 name DMZ-LOCAL-6 rule 140 protocol 'icmpv6'

# DMZ -> VMNET
set firewall ipv6 name DMZ-VMNET-6 default-action 'drop'
set firewall ipv6 name DMZ-VMNET-6 default-log
set firewall ipv6 name DMZ-VMNET-6 description 'DMZ to VMNET IPv6'
...
set firewall ipv6 name DMZ-WIFI-6 description 'DMZ to WIFI IPv6'
